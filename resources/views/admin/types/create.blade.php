    ...
    <div class="container">
        ...
        <div class="row">
            <form action="{{ route('admin.types.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input required class="form-control my-1 @error('name') is-invalid @enderror" type="text" id="name"
                ...
                <input type="file" accept="image/*" name="ascended_sprite" id="ascended_sprite"
