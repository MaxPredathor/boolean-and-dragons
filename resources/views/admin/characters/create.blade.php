    ...
    <form action="{{ route('admin.characters.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid
                    @enderror" id="name" required name="name" value="{{ old('name') }}">
            @error('name')
        ...
        <div class="row">
            ...
            <div class="col-2">
                <input id="type{{ $type->id }}" class="form-radio @error('type') is-invalid
                            @enderror" type="radio" name="type_id" value="{{ $type->id }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('attack') is-invalid
                    @enderror" id="attack" required name="attack" value="{{ old('attack') }}">
            @error('attack')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('defence') is-invalid
                    @enderror" id="defence" required name="defence" value="{{ old('defence') }}">
            @error('defence')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('speed') is-invalid
                    @enderror" id="speed" required name="speed" value="{{ old('speed') }}">
            @error('speed')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('life') is-invalid
                    @enderror" id="life" required name="life" value="{{ old('life') }}">
            @error('life')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input value="{{ old('image') }}" type="file" class="form-control @error('image') is-invalid
