        ...
        <section class="container">
            <form action="{{ route('admin.characters.store', $character->slug) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    @enderror"
                        id="name" required name="name" value="{{ old('name', $character->name) }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    @enderror" id="description"
                        aria-describedby="emailHelp" name="description">{{ old('description', $character->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    @enderror"
                        id="attack" required name="attack" value="{{ old('attack', $character->attack) }}">
                    @error('attack')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    @enderror"
                        id="defence" required name="defence" value="{{ old('defence', $character->defence) }}">
                    @error('defence')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    @enderror"
                        id="speed" required name="speed" value="{{ old('speed', $character->speed) }}">
                    @error('speed')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    @enderror"
                        id="life" required name="life" value="{{ old('life', $character->life) }}">
                    @error('life')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
