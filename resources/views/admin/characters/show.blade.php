                        ...
                        <div id="button">
                            <div class="w-75 d-flex flex-column justify-content-between align-items-center">
                                <div class="px-5 d-flex">
                                    <div>
                                        <img class="icon-square"
                                            src="{{ Vite::asset('public/images/characters_icons/attack.png') }}" alt="">
                                    </div>
                                ...
                                <div class="px-5">
                                    <div>
                                        <img class="icon-square"
                                            src="{{ Vite::asset('public/images/characters_icons/speed.png') }}" alt="">
                                    </div>
                                ...
                                <div class="px-5">
                                    <div>
                                        <img class="icon-square"
                                            src="{{ Vite::asset('public/images/characters_icons/life.png') }}" alt="">
                                    </div>
