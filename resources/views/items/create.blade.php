        ...
        <div class="row">
            <form action="{{route('items.store')}}" method="POST">
                ...
                <div>
                    ...
                    <input required class="form-control my-1" type="text" id="name" name="name" placeholder="Name">
                </div>
                <div>
                    <label for="slug">Slug:</label>
                    <input required class="form-control my-1" type="text" id="slug" name="slug" placeholder="Slug">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input required class="form-control my-1" type="text" id="cost" name="cost" placeholder="Cost">
                </div>
